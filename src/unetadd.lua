function get_base_net(step)
  if step == 1 then
    ...
    local dec2 = nn.CAddTable(true)({dec2, enc2})
    local dec2 = cudnn.VolumetricConvolution(64,32, 3,3,3, 1,1,1, 1,1,1)(dec2)
    ...
    local dec1 = nn.CAddTable(true)({dec1, enc1})
    local dec1 = cudnn.VolumetricConvolution(32,16, 3,3,3, 1,1,1, 1,1,1)(dec1)
    ...
    local add_dec2 = nn.CAddTable(true)
    add_dec2.output = oc.FloatOctree()
    local dec2 = add_dec2({dec2, enc2})
    local dec2 = oc.OctreeConvolutionMM(64,32, n_grids)(dec2)
    ...
    local add_dec1 = nn.CAddTable(true)
    add_dec1.output = oc.FloatOctree()
    local dec1 = add_dec1({dec1, enc1})
    local dec1 = oc.OctreeConvolutionMM(32,16, n_grids)(dec1)
